...
def run_get_batch(
    ...
    """
    return my_tf.modules.get_batch(
        dataset=dataset,
...
def run_cross_entropy(inputs: Float[Tensor, " batch_size vocab_size"], targets: Int[Tensor, " batch_size"]) -> Float[Tensor, ""]:
    ...
    """
    return my_tf.modules.get_cross_entropy_loss(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    my_tf.modules.get_gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return my_tf.modules.get_lr_cosine_schedule(
        it,
        max_learning_rate,
        min_learning_rate,
        warmup_iters,
...
def run_load_checkpoint(
    ...
    """
    return my_tf.modules.load_checkpoint(
        src=src,
        model=model,
        optimizer=optimizer,
    )
